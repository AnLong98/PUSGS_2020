...
using SmartEnergy.Physical.Mapping;
using SmartEnergy.Physical.Service;
using System;
...
namespace SmartEnergy.Physical
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           .AddJwtBearer(options =>
           {
            ...
            services.AddDbContext<PhysicalDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("PhysicalDatabase")));
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Smart Energy Physical API", Version = "v1" });
        ...
        public void InitDb(PhysicalDbContext context)
        {
            if (!context.Exists())
            {
